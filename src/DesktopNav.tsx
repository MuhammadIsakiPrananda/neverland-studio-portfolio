...
import NavItems from './component/ui/NavItems';
import ProfileDropdown from './component/sections/ProfileDropdown';
    ...
    <nav className="hidden md:flex fixed top-4 left-0 right-0 z-50 px-6">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => handleNavClick('Contact')} className="btn-shine bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-4 py-2 rounded-full shadow-md shadow-cyan-900/50 hover:shadow-lg hover:shadow-cyan-500/30 transition-all text-sm font-semibold transform hover:-translate-y-0.5 tracking-wide ml-2">
              Get Started
          </button>
        </div>
      </motion.div>
