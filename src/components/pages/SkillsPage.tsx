...
export default function SkillsPage({ theme }: SkillsPageProps) {
  ...
  return (
    <div className={`relative min-h-screen -mt-20 pt-32 overflow-hidden ${isDark ? 'bg-slate-950' : 'bg-slate-50'}`}>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-3xl mx-auto animate-fade-in-up delay-300">
              {[
                ...
                { label: t('skills.stats.experience'), value: '8+', icon: <TrendingUp className="w-5 h-5" /> },
              ].map((stat, idx) => (
                <div
                  key={idx}
