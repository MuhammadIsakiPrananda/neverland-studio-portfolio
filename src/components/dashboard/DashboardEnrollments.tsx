          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <select
                ...
                className={`w-full h-10 px-4 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 ${
                  isDark
              ...
              <form onSubmit={handleSubmit} className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-2 rounded-xl transition-colors ${isDark
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 rounded-xl transition-colors ${isDark
                          ? 'bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:border-blue-400'
                          : 'bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:border-slate-400'
                        } focus:outline-none`}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className={`w-full px-4 py-2 rounded-xl transition-colors resize-none ${isDark
                          ? 'bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:border-blue-400'
                          : 'bg-slate-50 border border-slate-200 text-slate-900 placeholder-slate-400 focus:border-slate-400'
                        } focus:outline-none`}
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className={`flex-1 px-4 py-2 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2 ${saving
