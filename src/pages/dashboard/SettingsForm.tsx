  ...
  return (
    <div className="text-white p-8 max-w-2xl mx-auto">
      ...
      <div className="flex items-center mb-8">
        <img src={userProfile.avatar || `https://api.dicebear.com/7.x/initials/svg?seed=${userProfile.name}`} alt="User Avatar" className="w-20 h-20 rounded-full mr-6 border-2 border-slate-600" />
        <div>
