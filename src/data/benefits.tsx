...
export const benefits: Benefit[] = [
  {
    ...
    spotlightColor: "rgba(45, 212, 191, 0.1)", // Teal
    borderColor: "border-teal-500/50",
    description: "We engineer future-proof digital platforms by leveraging next-generation technology, ensuring your brand not only competes but leads.",
    details: [
  ...
  },
  {
    ...
    spotlightColor: "rgba(52, 211, 153, 0.1)", // Emerald
    borderColor: "border-emerald-500/50",
    description: "From pixel-perfect UIs to robust back-end logic, our commitment to quality is absolute and evident in every detail.",
    details: [
  ...
  },
  {
    ...
    description: "We integrate with your team, fostering transparent communication and a shared commitment to your goals.",
    details: [
  ...
  },
  {
    ...
    description: "Our data-driven strategy ensures every design and development choice is purposeful and aligned with your business objectives.",
    details: [
