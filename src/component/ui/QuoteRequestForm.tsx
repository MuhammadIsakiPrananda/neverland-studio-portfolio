...
import { User, Mail, Building, Briefcase, MessageSquare, DollarSign, Send, Loader, AlertCircle } from 'lucide-react';
...
const QuoteRequestForm: React.FC<QuoteRequestFormProps> = ({ onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      addNotification('Quote Request Sent!', 'We will get back to you shortly.', 'success');
      onClose();
    }, 2000);
  };
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" exit="exit">
      <motion.h2 variants={itemVariants} className="text-2xl font-bold text-white mb-6 text-center">Request a Quote</motion.h2>
