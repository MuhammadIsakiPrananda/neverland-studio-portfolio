      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" variants={containerVariants}>
          {services.map((service, idx) => (
            <SpotlightCard
              key={idx}
              className="bg-gradient-to-br from-slate-900/80 to-black/80 backdrop-blur-lg border border-slate-800/50 rounded-2xl p-8 hover:border-teal-500/50 transition-all hover:transform hover:-translate-y-2"
            >
        ...
        <div className="text-center mt-12">
          <button 
            ...
            className="bg-gradient-to-r from-teal-500 to-emerald-600 text-white px-8 py-4 rounded-full font-semibold hover:shadow-xl hover:shadow-emerald-500/30 transition-all transform hover:scale-105"
          >
