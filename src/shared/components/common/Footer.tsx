                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {paymentMethods.map((method, index) => (
                    <motion.div
                      ...
                      className="group relative bg-white border-2 border-slate-200 rounded-xl p-2 w-20 h-12 sm:w-24 sm:h-16 flex items-center justify-center transition-all duration-300 hover:border-amber-400 hover:shadow-xl hover:shadow-amber-500/20 hover:scale-105 overflow-hidden"
                    >
                      ...
                      {/* Bottom indicator */}
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-1 bg-gradient-to-r from-amber-500 via-amber-400 to-amber-600 group-hover:w-full transition-all duration-300 rounded-t-full"></div>
