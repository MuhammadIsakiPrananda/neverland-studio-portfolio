          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Creating extraordinary digital experiences that inspire and
                engage. We transform ideas into innovative solutions that drive
                growth and success.
              </p>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
                  {paymentMethods.map((method) => (
                    <div
                      key={method.name}
                      className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-0 h-14 flex items-center justify-center transition-all duration-300 hover:border-amber-500/50 hover:scale-110 hover:bg-slate-800"
                    >
                      <img
                        src={method.iconSrc}
                        alt={method.name}
