      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            ...
            {/* Menu Panel */}
            <motion.div
              className="fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-slate-950/80 backdrop-blur-2xl border-l border-slate-800 shadow-2xl shadow-black/30 z-50"
                ...
                <div className="mt-auto">
                  ...
                  {isLoggedIn ? (
                    <motion.div variants={menuItemVariants}>
                      <div className="text-center text-sm text-slate-400 p-4 border-t border-slate-800">
                        Signed in as{" "}
