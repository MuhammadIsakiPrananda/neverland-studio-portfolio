          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            ...
            <div className="pt-8 border-t border-gray-700/50"> 
              ...
              <div className="flex gap-4">
                {[
                  { Icon: Github, href: "https://github.com/MuhammadIsakiPrananda" },
                  { Icon: Linkedin, href: "https://www.linkedin.com/in/muhammad-isaki-prananda-454668240/" },
                  { Icon: Instagram, href: "https://www.instagram.com/tuanmudazaky_/" },
                  { Icon: Twitter, href: "#" },
              ].map(({ Icon, href }, idx) => (
                  <a
                    key={idx} 
