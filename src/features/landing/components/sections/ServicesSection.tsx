          ...
          {services.map((service, idx) => (
            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col">
                <div className="w-16 h-16 mb-6 bg-slate-900 border border-white/10 rounded-xl flex items-center justify-center text-amber-400 shadow-lg shadow-black/20 group-hover:scale-105 group-hover:border-amber-500/50 group-hover:shadow-[0_0_15px_rgba(245,158,11,0.3)] transition-all duration-300">
