          ...
          {pricing.map((plan, idx) => (
            ...
            >
              <div className="relative z-10">
                {plan.popular && (
                  <div className="bg-gradient-to-r from-amber-400 to-amber-600 text-white text-sm font-bold py-2 px-4 rounded-full inline-block mb-4">
                    {t("pricing.popular")}
                  </div>
                )}
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-full font-semibold transition-all transform hover:scale-105 ${
                    plan.popular
                      ? "bg-gradient-to-r from-amber-400 to-amber-600 text-white shadow-lg shadow-amber-500/20 hover:shadow-xl hover:shadow-amber-500/30"
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <button
              ...
              className="bg-gradient-to-r from-amber-400 to-amber-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg shadow-amber-500/20 hover:shadow-xl hover:shadow-amber-500/30 transition-all transform hover:scale-105 flex items-center gap-3 group"
            >
