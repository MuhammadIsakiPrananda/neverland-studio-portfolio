        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-400 to-amber-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg shadow-amber-500/20 hover:shadow-xl hover:shadow-amber-500/30 transition-all flex items-center justify-center gap-2 group transform hover:scale-105"
            >
              {t("cta.button")}
          ...
          <div className="space-y-6">
            {[
              ...
              {
                icon: <Linkedin className="w-6 h-6 text-amber-400" />,
              ...
              <motion.a
                ...
                className="bg-slate-800/50 border border-white/10 rounded-xl p-6 flex items-center justify-between hover:bg-slate-800/80 hover:border-amber-500/50 transition-all cursor-pointer group"
