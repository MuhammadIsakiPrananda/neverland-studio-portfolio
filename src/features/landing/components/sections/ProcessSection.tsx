            ...
            {process.map((step, idx) => (
              ...
              >
                ...
                <div className="relative z-10 flex-shrink-0 flex flex-col items-center">
                  <div className="w-20 h-20 bg-slate-900 border-2 border-slate-800 rounded-full flex items-center justify-center text-amber-400 transition-colors group-hover:border-amber-500 group-hover:shadow-[0_0_15px_rgba(245,158,11,0.3)]">
                ...
                {/* Content Card */}
                <div className="bg-slate-900/60 backdrop-blur-lg border border-white/10 rounded-2xl p-6 flex-1 transition-all hover:border-amber-500/50 hover:shadow-2xl hover:shadow-amber-500/10">
