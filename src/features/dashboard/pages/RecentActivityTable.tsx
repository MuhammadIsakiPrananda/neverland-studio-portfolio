...
const submissions: Submission[] = [
  {
    ...
    type: "Review",
    timestamp: "2 min ago",
    summary: 'Gave 5 stars for "Project X"',
  },
  {
    id: "APP001",
    name: "John Smith",
    ...
    summary: "Applied for Frontend Developer",
  },
  {
    id: "COL001",
    name: "Innovate Corp",
  ...
  },
  {
    ...
    summary: "Reported a bug on the contact page",
  },
  {
    id: "APP002",
    name: "Emily White",
    type: "Applicant",
    timestamp: "1 day ago",
    summary: "Applied for UI/UX Designer",
  },
];

const typeDetails = {
  Review: { icon: FiMessageSquare, color: "text-sky-400" },
  Applicant: { icon: FiUsers, color: "text-premium-champagne-gold-400" },
              ...
              return (
                ...
                >
                  <td className="py-4 px-4">
                    <div
                      className={`flex items-center gap-2 font-medium ${details.color}`}
                    >
