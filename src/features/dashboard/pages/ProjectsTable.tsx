...
const ProjectsTable = ({ projects, onEdit, onDelete }: ProjectsTableProps) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "in_progress":
        return "bg-fresh-coral-500/20 text-fresh-coral-400 border-fresh-coral-500/30";
      case "pending":
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <div className="flex-1 bg-slate-700 rounded-full h-2 overflow-hidden">
                        <div
                          className="h-full bg-gradient-to-r from-fresh-mint-500 to-cyan-500 transition-all duration-300"
