        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-sm ${
                  is2faEnabled ? "text-emerald-400" : "text-slate-400"
                }`}
              >
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  ...
                  <div className="w-full space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() => copyToClipboard(totp.secret.base32)}
                    ...
                    <form onSubmit={handleVerify2FA} className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="w-full bg-slate-700 text-slate-300 py-2 rounded-lg font-semibold hover:bg-slate-600 text-sm"
                        >
                          Cancel
                        </button>
                      </div>
