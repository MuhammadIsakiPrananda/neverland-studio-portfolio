      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-950/50 border border-slate-800 rounded-lg px-4 py-3 text-slate-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/30 focus:outline-none transition-colors"
            required
          >
        ...
        <div>
          ...
          <input type="text" value={number} onChange={(e) => setNumber(e.target.value)} placeholder="e.g., 88081234567890" className="w-full bg-slate-950/50 border border-slate-800 rounded-lg px-4 py-3 text-slate-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/30 focus:outline-none transition-colors" required />
        </div>
      </div>
