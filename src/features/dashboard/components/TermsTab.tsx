      ...
      >
        <div className="prose prose-invert max-w-none prose-p:text-slate-300 prose-headings:text-white prose-strong:text-white prose-a:text-amber-400 hover:prose-a:text-amber-300">
          ...
          <p>
            ...
            use of Neverland Studio's Website, located at yourwebsite.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Neverland Studio if you do not
          ...
          <p>
            ...
            Studio. All intellectual property rights are reserved. You may
            access this from Neverland Studio for your own personal use
